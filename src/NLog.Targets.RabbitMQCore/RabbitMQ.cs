...
namespace NLog.Targets
{
    ...
    public class RabbitMQ : TargetWithLayout
    {
        ...
        {
            System.Reflection.EventInfo connectionShutdownEventInfo = typeof(IConnection).GetTypeInfo().GetEvent("ConnectionShutdown");
            _connectionShutdownEventAddMethod = connectionShutdownEventInfo.GetAddMethod();

            var delegateType = connectionShutdownEventInfo.EventHandlerType.GetTypeInfo();
            ...
            _connectionShutdownEventHandler = shutdownAmqpMethodInfo.CreateDelegate(connectionShutdownEventInfo.EventHandlerType, this);
        }
